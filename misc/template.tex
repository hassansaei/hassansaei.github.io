...
\begin{rSection}{Analytic and Computational Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Disease models & Kidney organoid development, Humanized mouse model
	\end{tabular}
...
\begin{enumerate}
  ...
  \textit{BioRxiv; submitted to Bioinformatics}. 2026. \href{https://www.biorxiv.org/content/10.64898/2026.05.08.723876v1}{[Full text]}
  ...
  \textit{medRxiv; submitted to Kidney International}. 2026. (\textsuperscript{*}co-first authors) \href{https://vntyper.org/}{[Web server]}
